      ...
      <div className='flex flex-col items-center w-full mt-3'>
        <div className='flex justify-between w-full -mb-2 p-2'>
          ...
          <div className='bg-black p-3 px-4 w-max rounded-3xl -mt-5 shadow-2xl'>
            <p className='text-[#37C7DA] font-bold select-none uppercase'>{timestamp}</p>
          </div>
      </div>
   </div>
  )
...
const Transactions = () => {
  ...
  return <div className='flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions'>
    <div className='flex flex-col md:p-12 py-12 px-4'>
      {connectedAccount ? (
        <h3 className='text-white text-center text-3xl my-2 text-gradient select-none'>Latest Transactions</h3>
      ): <h3 className='text-white text-center text-3xl my-2  text-gradient select-none'>Connect your Account to see the Latest Transactions</h3>}
      <div className='flex flex-wrap justify-center items-center mt-10 '>
        {connectedAccount ? transactions.reverse().map(( transaction, i ) => (
